                ...
                <section>
                    <div class="container">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">PRIVATE DINING ROOM THE ROCKS</h4>
                                    </div>
                                    <div class="row">
                                        <div class="modal-body">
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE ULTIMATE PRIVATE DINING EXPERIENCE</h5>
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">UrbanXchange Private Dining Room</h1>
                            <p class="location">The Rocks 12 Argyle Street</p>
                            <p class="definition">
                            Sitting amongst historic sandstone, the Urban Xchange Private Dining
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel">Ananas Bar & Brasserie</h4>
                                    </div>
                                    <div class="row">
                                        <div class="modal-body">
                                            <div class="col-md-6">
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>A CORNER OF PARIS IN THE ROCKS</h5>
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Ananas Bar & Brasserie</h1>
                        ...
                        <div class="modal fade" id="argyle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel">The Argyle</h4>
                                    </div>
                                    <div class="row">
                                        <div class="modal-body">
                                            <div class="col-md-6">
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>FIVE BARS OVER TWO LEVELS, AT ONE VENUE IN THE ROCKS</h5>
                                                <p>
